const BeansData = [
    {
      ...
      imagelinkSquare: require('../../assets/coffee_assets/robusta_coffee_beans/robusta_coffee_beans_square.png'),
      imagelinkPortrait: require('../../assets/coffee_assets/robusta_coffee_beans/robusta_coffee_beans_portrait.png'),
      ingredients: 'Africa',
      specialIngredient: 'From Africa',
      prices: [
    ...
    },
    {
      ...
      roasted: 'Medium Roasted',
      imagelinkSquare: require('../../assets/coffee_assets/arabica_coffee_beans/arabica_coffee_beans_square.png'),
      imagelinkPortrait: require('../../assets/coffee_assets/arabica_coffee_beans/arabica_coffee_beans_portrait.png'),
      ingredients: 'Africa',
      specialIngredient: 'From Africa',
      prices: [
        {size: '250gm', price: '5.50', currency: '$'},
    ...
    },
    {
      ...
      roasted: 'Medium Roasted',
      imagelinkSquare: require('../../assets/coffee_assets/liberica_coffee_beans/liberica_coffee_beans_square.png'),
      imagelinkPortrait: require('../../assets/coffee_assets/liberica_coffee_beans/liberica_coffee_beans_portrait.png'),
      ingredients: 'Malaysia',
      specialIngredient: 'From Malaysia',
      prices: [
        {size: '250gm', price: '5.50', currency: '$'},
        {size: '500gm', price: '10.50', currency: '$'},
        {size: '1Kg', price: '18.50', currency: '$'},
    ...
    },
    {
      ...
      roasted: 'Medium Roasted',
      imagelinkSquare: require('../../assets/coffee_assets/excelsa_coffee_beans/excelsa_coffee_beans_square.png'),
      imagelinkPortrait: require('../../assets/coffee_assets/excelsa_coffee_beans/excelsa_coffee_beans_portrait.png'),
      ingredients: 'Malaysia',
      specialIngredient: 'From Malaysia',
      prices: [
        {size: '250gm', price: '5.50', currency: '$'},
